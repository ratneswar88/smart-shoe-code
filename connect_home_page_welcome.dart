...
/// - automatically routes to dashboard after a short delay
///
/// NOTE:
...
/// The BLE parameters are accepted for compatibility, but the welcome page
/// itself no longer shows connectivity controls.
...
class _ConnectHomePageState extends State<ConnectHomePage> {
  ...
  Future<void> _bootstrap() async {
    ...
    try {
      ...
      // Later launches: briefly show the home/welcome page,
      // then move to dashboard automatically.
      if (seen) {
        _autoNavTimer?.cancel();
        _autoNavTimer = Timer(const Duration(milliseconds: 900), () {
          if (mounted) {
      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            Text(
              _hasSeenWelcome
                  ? 'Later launches pass through this page briefly, then continue to the dashboard automatically.'
                  : 'On your next launches, this welcome page will appear briefly and continue to the dashboard automatically.',
