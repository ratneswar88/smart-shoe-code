...
class ShoeBle {
  ...
  /// The BLE id of the currently *connected* device, or null when disconnected.
  /// Use this instead of `device?.id` — ShoeBle does not expose DiscoveredDevice.
  String? get connectedId => _isConnected ? _deviceId : null;

  /// The human-readable name of the last successfully connected device, or null.
  String? get connectedName => _lastName;
