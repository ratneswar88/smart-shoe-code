...
// ---------- BLE callbacks (no 'override') ----------
class ServerCallbacks : public NimBLEServerCallbacks {
public:
  void onConnect(NimBLEServer*) { LOGLN("[BLE] Connected"); }
  void onDisconnect(NimBLEServer*) { LOGLN("[BLE] Disconnected -> re-adv"); NimBLEDevice::startAdvertising(); }
};
...
void loop(){
  ...
  if(millis()-lastAdvKick > 5000){ NimBLEDevice::startAdvertising(); lastAdvKick=millis(); }
