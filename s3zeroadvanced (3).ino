...
#include <Arduino.h>
// esp_task_wdt.h omitted — WDT init crashes this board variant at startup.
#include <math.h>
#include <Wire.h>
...
void setup(){
  ...
  // WDT: not configured here — esp_task_wdt_reconfigure/init/deinit all
  // crash on this board variant (WDT struct NULL at startup).
  // esp_task_wdt_reset() in loop() is a harmless no-op when unregistered.
}

// ---------- Loop ----------
void loop(){
  // esp_task_wdt_reset() removed — WDT not initialized
