...
void setup(){
  ...
  // Watchdog: 5 s timeout, reboot on hang (e.g. I2C bus lockup)
  // IDF v5.x uses a config struct; v4.x used (timeout_s, panic) directly.
...
void loop(){
  ...
  if(now - lastSample >= samplePeriodMs){
    ...
    // Model-based quick stride estimate
