...
class ShoeBle {
  ...
  final Uuid stepsUuid   = Uuid.parse("0000c001-0000-1000-00805f9b34fb");
  final Uuid cadenceUuid = Uuid.parse("0000c002-0000-1000-00805f9b34fb");
  final Uuid strideUuid  = Uuid.parse("0000c003-0000-1000-00805f9b34fb");
  final Uuid altdhUuid   = Uuid.parse("0000c004-0000-1000-00805f9b34fb");
  ...
  Future<File?> _saveGpx(File csvFile) async {
    try {
      ...
      for (int i = 0; i < _track.length; i++) {
        ...
        b.writeln('      <trkpt lat="${p.latitude}" lon="${p.longitude}"><time>$t</time></trkpt>');
      }
      b.writeln('    </trkseg>');
      b.writeln('  </trk>');
      b.writeln('</gpx>');
