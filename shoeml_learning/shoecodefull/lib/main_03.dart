        ...
        return Padding(
          ...
          child: Wrap(
            children: [
              ...
              const SizedBox(height: 8),
              Text("Distance travelled: " + distTxt, style: const TextStyle(fontSize: 16)),
              ...
              ElevatedButton.icon(
                onPressed: () async {
                  final msg = "Training distance: " + distTxt;
                  if (png != null) {
                    await Share.shareXFiles([XFile(png.path)], text: msg);
                  } else {
