...
class _DashboardPageState extends State<DashboardPage> {
  ...
  void _bind() {
    ...
    _s5 = widget.ble.temp$.stream.listen((v) => setState(() => tempC = v));
...
// raw samples buffer for CSV/windows
  ...
  void _bind() {
    ...
    _st = widget.ble.temp$.stream.listen((v) {
...
if (_collecting) {
  ...
  if (f != null) {
    ...
    await _showSummarySheet(f, png, geo, gpx);
  }
}
}
...
const SizedBox(height: 12),
  ...
  Future<void> _showSummarySheet(File f, File? png, File? geo, File? gpx) async {
